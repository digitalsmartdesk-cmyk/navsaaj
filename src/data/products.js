...
export const COLLECTIONS = [
  {
    ...
    loom: 'Surat',
    loomImg: asset('/images/loom-zardozi-vault.jpg'),
  ...
  },
  {
    ...
    loom: 'Kutch',
    loomImg: asset('/images/loom-mirror-tale.jpg'),
  ...
  },
  {
    ...
    loom: 'Jaipur',
    loomImg: asset('/images/loom-gota-bloom.jpg'),
  ...
  },
  {
    ...
    loom: 'Lucknow',
    loomImg: asset('/images/loom-chikan-noor.jpg'),
  ...
  },
  {
    ...
    loom: 'Varanasi',
    loomImg: asset('/images/loom-banarasi-drape.jpg'),
  ...
  COLLECTIONS.forEach((coll, cIdx) => {
    for (let j = 1; j <= 8; j++) {
      ...
      list.push({
        ...
        description: `Hand-embroidered in ${coll.loom}, this ${coll.fabric.toLowerCase()} lehenga set features ${coll.weave.toLowerCase()} in ${colorway.toLowerCase()} tones. Part of the ${coll.name} line — only 10 sets of this design are made this edit; once sold, it will not be remade until ${coll.name} returns in a future edit.`,
        weaverStory: `Hand-embroidered over 21 days by master artisan families in ${coll.loom}, continuing a technique passed down four generations. Your purchase directly supports the atelier collective behind this set.`,
        specs: [
